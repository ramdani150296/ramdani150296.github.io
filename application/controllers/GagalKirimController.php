...
class GagalKirimController extends CI_Controller {

	public function __construct(){
		parent::__construct();
		$this->load->model('GagalKirimModel');
	...
	public function index(){
		if(strtolower($_SERVER['REQUEST_METHOD']) === 'get'){
			...
			$this->parser->parse('GagalKirimPage', $data); // main content
    ...
    public function doInsertData(){
        $response = "";
        $status = "Error";
        $response .= doImportExcel($this->GagalKirimModel, $this->db);
    ...
    public function getAllData(){
        return resultsDataToJson($this->GagalKirimModel);
    }
